...
# Queue auto gain to be enabled after rtl_fm initializes
# The queue is processed by the rtl_fm_thread after device is ready
from rtl_fm_python_thread import queue
queue.append(set_auto_gain)
